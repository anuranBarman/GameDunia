...
public class GamesbyCompanies extends AppCompatActivity {
    ...
    private final String link="http://anuranbarman.com/gamedunia/gamesbycompanies.php";
    Toolbar toolbar;
    ProgressDialog progressDialog;
    String catID,companyName;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(companyName+" Games");
        ...
        adapter=new CustomAdapter(GamesbyCompanies.this,data_list);
        recyclerView.setAdapter(adapter);
        recyclerView.addOnItemTouchListener(new GamesbyCompanies.RecyclerTouchListener(GamesbyCompanies.this, recyclerView, new GamesbyCompanies.ClickListener() {
            @Override
            public void onClick(View view, int position) {
                ...
                Intent i = new Intent(GamesbyCompanies.this,ProductView.class);
                i.putExtras(bundle);
                startActivity(i);
        ...
        gridLayoutManager=new GridLayoutManager(GamesbyCompanies.this,2);
    ...
    class ShowProducts extends AsyncTask<String,Void,Void> {
        ...
        protected void onPreExecute() {
            progressDialog=new ProgressDialog(GamesbyCompanies.this);
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String encoded_data= URLEncoder.encode("brand_id","UTF-8")+"="+URLEncoder.encode(catID,"UTF-8");
    ...
    class RecyclerTouchListener implements RecyclerView.OnItemTouchListener{
        ...
        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final GamesbyCompanies.ClickListener clickListener){

...
public class Companies extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Shop by Game Companies");
        ...
        new FetchCat().execute("http://anuranbarman.com/gamedunia/companies.php");
    ...
    class FetchCat extends AsyncTask<String,Void,Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            customCatAdapter=new CustomCatAdapter(Companies.this,my_data);
            ...
            catList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent=new Intent(Companies.this,GamesbyCompanies.class);

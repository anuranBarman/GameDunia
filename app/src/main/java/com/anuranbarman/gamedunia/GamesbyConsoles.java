...
public class GamesbyConsoles extends AppCompatActivity {
    ...
    private final String link="http://anuranbarman.com/gamedunia/gamesbyconsoles.php";
    Toolbar toolbar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        companyName=getIntent().getExtras().getString("console");
        ...
        adapter=new CustomAdapter(GamesbyConsoles.this,data_list);
        recyclerView.setAdapter(adapter);
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(GamesbyConsoles.this, recyclerView, new GamesbyConsoles.ClickListener() {
            @Override
            public void onClick(View view, int position) {
                ...
                Intent i = new Intent(GamesbyConsoles.this,ProductView.class);
                i.putExtras(bundle);
                startActivity(i);
        ...
        gridLayoutManager=new GridLayoutManager(GamesbyConsoles.this,2);
    ...
    class ShowProducts extends AsyncTask<String,Void,Void> {
        ...
        protected void onPreExecute() {
            progressDialog=new ProgressDialog(GamesbyConsoles.this);
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String encoded_data= URLEncoder.encode("console_id","UTF-8")+"="+URLEncoder.encode(catID,"UTF-8");

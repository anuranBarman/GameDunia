...
public class Consoles extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Shop by Game Consoles");
        ...
        new FetchCat().execute("http://anuranbarman.com/gamedunia/consoles.php");
    ...
    class FetchCat extends AsyncTask<String,Void,Void> {
        ...
        protected void onPreExecute() {
            progressDialog=new ProgressDialog(Consoles.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            customCatAdapter=new CustomCatAdapter(Consoles.this,my_data);
            ...
            catList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent=new Intent(Consoles.this,GamesbyConsoles.class);
                    TextView companyName=(TextView)view.findViewById(R.id.catName);
                    String company=companyName.getText().toString();
                    Bundle bundle=new Bundle();
                    bundle.putString("id",Long.toString(parent.getItemIdAtPosition(position)+1));
                    bundle.putString("console",company);
